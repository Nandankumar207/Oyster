...
public class TakeImage extends Activity
{
	...
	private final String capture_dir = Environment.getExternalStorageDirectory() + "/Asec/Images/";
	Activity activity;
...
//				imageFileUri = FileProvider.getUriForFile(TakeImage.this,BuildConfig.APPLICATION_ID + ".provider",new File(path));
				imageFileUri = FileProvider.getUriForFile(TakeImage.this,"com.asec",new File(path));
